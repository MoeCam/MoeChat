...
-(void)layoutSubviews{
    ...
    [_bubbleImageView setImage:
     [UIImage imageNamed:CHATCELL_BUBBLE_LEFT_IMAGE]];
    [_bubbleImageView setHighlightedImage:
     [UIImage imageNamed:CHATCELL_BUBBLE_LEFT_HIGHLIGHT_IMAGE]];
