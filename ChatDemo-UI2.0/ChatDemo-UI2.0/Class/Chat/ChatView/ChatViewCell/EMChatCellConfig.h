...
#define CHATCELL_HEAD_SIZE 30 // chatCell中，头像的大小
#define CHATCELL_HEAD_DEFAULT_IMAGE @"" // 默认显示头像

#define CHATCELL_CHATNAME_HEAD_HEIGHT 4 // 头像距离名字的距离（群聊中，显示人名用）
#define CHATCELL_CHATNAMAE_HEIGHT 10 // nameLabel 高度

#define CHATCELL_BUBBLE_LEFT_IMAGE @"" // 左bubbleView 默认图片
#define CHATCELL_BUBBLE_LEFT_HIGHLIGHT_IMAGE @"" // 左bubbleView 高亮图片
#define CHATCELL_BUBBLE_RIGHT_IMAGE @"" // 右bubbleView 默认图片
