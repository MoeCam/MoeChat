...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[XDChatListCell class] forCellReuseIdentifier:@"chatListCell"];
    }
    return _tableView;
}
...
heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [XDChatListCell tableView:tableView heightForRowAtIndexPath:indexPath];
}
