//
//  EMASICloudFilesObjectRequest.h
//
...
@class EMASICloudFilesObject;

@interface EMASICloudFilesObjectRequest : EMASICloudFilesRequest <NSXMLParserDelegate> {
	...
	EMASICloudFilesObject *currentObject;
...
@property (retain) EMASICloudFilesObject *currentObject;
