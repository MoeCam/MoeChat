...
@interface EMASIS3ObjectRequest : EMASIS3Request {
...
// Examples:
// Fetch ACL:
// EMASIS3ObjectRequest *request = [EMASIS3ObjectRequest requestWithBucket:@"mybucket" key:@"my-key" parameter:@"acl"];
// Get object torret:
// EMASIS3ObjectRequest *request = [EMASIS3ObjectRequest requestWithBucket:@"mybucket" key:@"my-key" parameter:@"torrent"];
