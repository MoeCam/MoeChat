...
@class EMASIS3BucketObject;

@interface EMASIS3BucketRequest : EMASIS3Request {
	...
	EMASIS3BucketObject *currentObject;
...
// Examples:
// Fetch ACL:
// EMASIS3BucketRequest *request = [EMASIS3BucketRequest requestWithBucket:@"mybucket" parameter:@"acl"];
// Fetch Location:
// EMASIS3BucketRequest *request = [EMASIS3BucketRequest requestWithBucket:@"mybucket" parameter:@"location"];
