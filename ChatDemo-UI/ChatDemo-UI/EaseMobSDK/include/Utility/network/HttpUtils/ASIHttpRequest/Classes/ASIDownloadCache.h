...
@interface EMASIDownloadCache : NSObject <ASICacheDelegate> {
...
// Returns a static instance of an EMASIDownloadCache
// In most circumstances, it will make sense to use this as a global cache, rather than creating your own cache
// To make ASIHTTPRequests use it automatically, use [EMASIHTTPRequest setDefaultCache:[EMASIDownloadCache sharedCache]];
+ (id)sharedCache;
